      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-th" style="line-height: 50px;padding-left: 2px;"></i> 设备查看 <span></span></h2>
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="补计划单.html">合同采购</a></li>
                <li class="active">补计划单</li>
              </ol>
            </div>
