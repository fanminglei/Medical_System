      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-check-square" style="line-height: 48px;padding-left: 1px;"></i> 退库申请设备表单 </h2>
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="退库申请设备表单.html">退库申请设备表单</a></li>
                <li class="active">退库申请设备表单</li>
              </ol>
            </div>
                  ...
                  <!-- /tile header -->
                      ...
                      <div class="form-group form-footer footer-black-transparent">
                        <div class="col-sm-offset-4 col-sm-8">
                          ...
                          <button type="reset" class="btn btn-default">查看</button>
						   <button type="submit" class="btn btn-default">撤销</button>
                          <button type="reset" class="btn btn-default">审核</button>
						   <button type="reset" class="btn btn-default">批量审核</button>
                        </div>
                      </div>
