      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-check-square" style="line-height: 48px;padding-left: 1px;"></i> 添加设备 <span></span></h2>
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations">
                      ...
                      <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">主设备名称 *</label>
                        <div class="col-sm-8">
					   ...
					   <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">数量 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="计划单号" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					   <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">单价 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="计划单号" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					   <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">规格 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="计划单号" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					   <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">型号 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="计划单号" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					   <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">经费 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="计划单号" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					   <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">设备用途 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="计划单号" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					   <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">国别 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="计划单号" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">厂家 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="计划单号" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">进货途径 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="计划单号" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
