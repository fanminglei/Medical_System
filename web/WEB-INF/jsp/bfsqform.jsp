      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-check-square" style="line-height: 48px;padding-left: 1px;"></i> 报废申请设备表单 </h2>
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="报废申请设备表单.html">报废申请设备表单</a></li>
                <li class="active">报废申请设备表单</li>
              </ol>
            </div>
