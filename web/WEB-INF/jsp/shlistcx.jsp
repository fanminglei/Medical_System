                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations">
					  ...
					  <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">申请单位 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="计划单号" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					   <div class="form-group">
                        <label for="input08" class="col-sm-4 control-label">日期 *</label>
                      ...
                      <div class="form-group">
                        <label for="password" class="col-sm-4 control-label">设备名称 *</label>
                        <div class="col-sm-8">
