          ...
          <div class="pageheader">
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="验收表表单页.html">合同验收</a></li>
                <li class="active">验收表表单页</li>
              </ol>
            </div>
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations">
                      ...
                      <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">申请日期 *</label>
                        <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        <label for="email" class="col-sm-4 control-label">规格 *</label>
                        <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        <label for="password" class="col-sm-4 control-label">型号 *</label>
                        <div class="col-sm-8">
                          ...
                          <div class="form-group">
                        <label for="input08" class="col-sm-4 control-label">计量单位 *</label>
                        <div class="col-sm-8" id="selectbox2">
                          <select multiple class="chosen-select chosen-transparent form-control" id="input08" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox2">
                            <option value="11">1</option>
                            <option value="222">2</option>
