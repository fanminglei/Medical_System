      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-puzzle-piece" style="line-height: 48px;padding-left: 5px;"></i> 该科室领用的设备列表 </h2>
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="该科室领用的设备列表.html">该科室领用的设备列表</a></li>
                <li class="active">该科室领用的设备列表</li>
              </ol>
            </div>
                    ...
                    <table class="table table-bordered table-sortable">
                      <thead>
                        <tr>
                          ...
                          <th class="sortable sort-alpha">设备编码</th>
                          <th class="sortable sort-alpha">设备标准名称</th>
                          <th class="sortable sort-alpha">型号</th>
						   <th class="sortable sort-alpha">规格</th>
						   <th class="sortable sort-alpha">单价</th>
						   <th class="sortable sort-alpha">国别</th>
						    <th class="sortable sort-alpha">供应商</th>
						   <th class="sortable sort-alpha">经费来源</th>
						   <th class="sortable sort-alpha">存放地点</th>
						   <th class="sortable sort-alpha">保管人</th>
						     <th class="sortable sort-alpha">入库时间</th>
						   <th class="sortable sort-alpha">使用年限</th>
