      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-check-square" style="line-height: 48px;padding-left: 1px;"></i> 外贸合同 <span></span></h2>
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="外贸合同.html">采购合同</a></li>
                <li class="active">外贸合同</li>
              </ol>
            </div>
                    ...
                    <form class="form-horizontal" role="form">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                         ...
                         <div class="form-group">
                        <label for="passwordconfirm" class="col-sm-4 control-label">外贸合同号*</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="passwordconfirm" parsley-trigger="change" parsley-required="true" parsley-minlength="6" parsley-type="alphanum" parsley-validation-minlength="1" parsley-equalto="#password">
                        </div>
                      </div>
					   <div class="form-group">
                        <label for="passwordconfirm" class="col-sm-4 control-label">外贸代理商*</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="passwordconfirm" parsley-trigger="change" parsley-required="true" parsley-minlength="6" parsley-type="alphanum" parsley-validation-minlength="1" parsley-equalto="#password">
                        </div>
                      </div>
					   <div class="form-group transparent-editor">
                        <label class="col-sm-4 control-label">外贸合同内容</label>
                        <div class="col-sm-8">
