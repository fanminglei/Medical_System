      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-puzzle-piece" style="line-height: 48px;padding-left: 5px;"></i> 通过审核的计划列表 </h2>
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="通过审核的计划列表.html">计划申请</a></li>
                <li class="active">通过审核的计划列表</li>
              </ol>
            </div>
                    ...
                    <table class="table table-bordered table-sortable">
                      <thead>
                        <tr>
                          ...
                          <th class="sortable sort-alpha">计划编号</th>
                          <th class="sortable sort-alpha">设备标准名称</th>
						   <th class="sortable sort-alpha">规格</th>
						   <th class="sortable sort-alpha">型号</th>
						   <th class="sortable sort-alpha">计量单位</th>
						    <th class="sortable sort-alpha">数量</th>
						   <th class="sortable sort-alpha">单价</th>
						   <th class="sortable sort-alpha">总金额</th>
						   <th class="sortable sort-alpha">经费</th>
						   <th class="sortable sort-alpha">申请科室</th>
						   <th class="sortable sort-alpha">申请人</th>
