      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-check-square" style="line-height: 48px;padding-left: 1px;"></i> 计划表单 <span>// Place subtitle here...</span></h2>
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="生成设备入库单表单.html">生成设备入库单表单</a></li>
                <li class="active">生成设备入库单表单</li>
              </ol>
            </div>
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations">
                      ...
                      <div class="form-group">
                        <label for="fullname" class="col-sm-4 control-label">分类代码 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="分类代码" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					   <div class="form-group">
                        <label for="input08" class="col-sm-4 control-label">设备名称 *</label>
                      ...
                      <div class="form-group">
                        <label for="email" class="col-sm-4 control-label">设备标准名称 *</label>
                        <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        <label for="password" class="col-sm-4 control-label">设备标准名称 *</label>
                        <div class="col-sm-8">
                          ...
                          <div class="form-group">
                        <label for="input08" class="col-sm-4 control-label">设备标准名称 *</label>
                        <div class="col-sm-8" id="selectbox2">
                          <select multiple class="chosen-select chosen-transparent form-control" id="input08" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox2">
                            <option value="11">1</option>
                            <option value="222">2</option>
                      ...
                      <div class="form-group">
                        <label for="passwordconfirm" class="col-sm-4 control-label">预计单价*</label>
                        <div class="col-sm-8">
					   ...
					   <div class="form-group">
                        <label for="input08" class="col-sm-4 control-label">资金来源 *</label>
                        <div class="col-sm-8" id="selectbox2">
                          <select multiple class="chosen-select chosen-transparent form-control" id="input08" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox2">
                            <option value="11">1</option>
                            <option value="222">2</option>
					   ...
					   <div class="form-group">
                        <label for="input08" class="col-sm-4 control-label">进货途径 *</label>
                        <div class="col-sm-8" id="selectbox2">
                          <select multiple class="chosen-select chosen-transparent form-control" id="input08" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox2">
                            <option value="11">1</option>
                            <option value="222">2</option>
					   ...
					   <div class="form-group">
                        <label for="input08" class="col-sm-4 control-label">设备用途 *</label>
                        <div class="col-sm-8" id="selectbox2">
                          <select multiple class="chosen-select chosen-transparent form-control" id="input08" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox2">
                            <option value="11">1</option>
                            <option value="222">2</option>
                     ...
                     <div class="form-group">
                        <label for="input08" class="col-sm-4 control-label">国别 *</label>
                        <div class="col-sm-8" id="selectbox2">
                          <select multiple class="chosen-select chosen-transparent form-control" id="input08" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox2">
                            <option value="11">1</option>
                            <option value="222">2</option>
                ...
                <section class="tile color transparent-white">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="numbervalidations">
                      ...
                      <div class="form-group">
                        <label for="minval" class="col-sm-4 control-label">生产厂家 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="minval" >
                        </div>
                      </div>

                      
                      <div class="form-group">
                        <label for="minval" class="col-sm-4 control-label">社会效益论证 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="minval" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="minval" class="col-sm-4 control-label">经济效益论证 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="minval" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="minval" class="col-sm-4 control-label">使用技术——技术可行性 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="minval" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="minval" class="col-sm-4 control-label">使用技术——安装配套条件 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="minval" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="minval" class="col-sm-4 control-label">功能要求及配置 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="minval" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="minval" class="col-sm-4 control-label">备注 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="minval" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="minval" class="col-sm-4 control-label">设备惯用名称 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="minval" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="minval" class="col-sm-4 control-label">设备英文名称 *</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="minval" >
                        </div>
                      </div>
