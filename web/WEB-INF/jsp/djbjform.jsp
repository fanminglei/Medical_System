      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-check-square" style="line-height: 48px;padding-left: 1px;"></i> 等级编辑表单 </h2>
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="等级编辑表单.html">等级编辑表单</a></li>
                <li class="active">等级编辑表单</li>
              </ol>
            </div>
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          ...
                          <div class="form-group">
                        <label for="password" class="col-sm-4 control-label">审核内容 *</label>
                        <div class="col-sm-8">
					   ...
					   <div class="form-group">
                        <label for="passwordconfirm" class="col-sm-4 control-label">等级*</label>
                        <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        <label for="passwordconfirm" class="col-sm-4 control-label">描述*</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="passwordconfirm" parsley-trigger="change" parsley-required="true" parsley-minlength="6" parsley-type="alphanum" parsley-validation-minlength="1" parsley-equalto="#password">
                        </div>
                      </div>
                         <div class="form-group">
                        <label for="passwordconfirm" class="col-sm-4 control-label">修改时间*</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="passwordconfirm" parsley-trigger="change" parsley-required="true" parsley-minlength="6" parsley-type="alphanum" parsley-validation-minlength="1" parsley-equalto="#password">
                        </div>
                      </div>
					   ...
					   <div class="form-group">
                        <label for="passwordconfirm" class="col-sm-4 control-label">附加条件内容*</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="passwordconfirm" parsley-trigger="change" parsley-required="true" parsley-minlength="6" parsley-type="alphanum" parsley-validation-minlength="1" parsley-equalto="#password">
                        </div>
                      </div>
