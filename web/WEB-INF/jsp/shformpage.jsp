      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-th" style="line-height: 50px;padding-left: 2px;"></i> 审核表单页 <span></span></h2>
            

            <div class="breadcrumbs">
              <ol class="breadcrumb">
                <li>You are here</li>
                <li><a href="index.html">计划审核</a></li>
                <li><a href="审核表单页.html">审核表单页</a></li>
                <li class="active">审核表单页</li>
              </ol>
            </div>
                ...
                <section class="tile color transparent-black">
                  <form class="form-horizontal" role="form" parsley-validate id="basicvalidations">
                      ...
                      <div class="form-group">
                        <label for="fullname" class="col-sm-3 tile-footer">&nbsp;&nbsp;&nbsp;&nbsp;备注：</label>
                        <div class="col-sm-8">
					   ...
					   <div class="form-group">
                        <label for="fullname" class="col-sm-3 tile-footer">&nbsp;&nbsp;&nbsp;&nbsp;审核人：</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="申请日期" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					   <div class="form-group">
                        <label for="fullname" class="col-sm-3 tile-footer">&nbsp;&nbsp;&nbsp;&nbsp;审核时间：</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="申请日期" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					  <div class="form-group">
                        <label for="fullname" class="col-sm-3 tile-footer">&nbsp;&nbsp;&nbsp;&nbsp;审核结果：</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="申请日期" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        <label for="fullname" class="col-sm-3 tile-footer">&nbsp;&nbsp;&nbsp;&nbsp;审核意见：</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="申请日期" parsley-trigger="change" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
					   <div class="col-sm-offset-4 col-sm-8 form-group">
                          <button type="submit" class="btn btn-default">审核</button>
                          <button type="reset" class="btn btn-default">返回</button>
						  <button type="button" class="btn btn-default">审核回滚</button>
                        </div>
                      </div>
